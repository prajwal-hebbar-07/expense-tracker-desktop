...
function App() {
  ...
  return (
    ...
    <>
      <UpdateBanner />
      {/* One nav, two shapes: a sticky top bar in a half-screen window, a side
          rail once there is room for one. `lg:flex-col` on the same element does
          it, so there is no second copy of the tabs to keep in sync. */}
